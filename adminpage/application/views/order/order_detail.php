					...
					<form method="post" action="<?php echo base_url() . 'order/konfirmasi' ?>">
						...
						<?php foreach ($transaksi as $k) : ?>
							<tr>
								...
								<td><input type="text" name="tgl_bayar" id="tgl_mulai" value="<?php echo $k['transaction_time'] ?> WIB" disabled></td>
							</tr>
							<tr>
								...
								<td><input type="text" name="nama_bayar" value="<?php echo $type ?>" disabled></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="text" name="rek_bayar" value="<?php echo $stat ?>" disabled></td>
							</tr>
							<!-- <tr>
