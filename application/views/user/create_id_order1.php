...
<div class="container">
    ...
    <div id="content" class="mb-invoice-3">
        ...
        <h5 style="margin-top:14px; margin-bottom: 30px"><span style="color:red;">*</span>Apabila pembayaran tidak dilakukan dalam <?= $expired[0]['waktu'] . " " . $satuan ?> maka pesanan anda akan dihapus</h5>
