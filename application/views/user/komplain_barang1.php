<div class="container">
    ...
    <?php if (isset($komplain_barang[0]['id_detail_order'])) : ?>
        ...
        <?php else : ?>
            <div class="alert alert-danger" role="alert"><strong>Komplain barang tidak disetujui oleh Admin</strong></div>
    <?php endif;
    endif; ?>
        ...
        <div class="col-md-6">
            <?php if (isset($komplain_barang[0]['id_detail_order'])) : ?>
                <?php if ($komplain_barang[0]['status_komplain'] == 'Disetujui') : ?>
                    <?php if ($komplain_barang[0]['jenis_komplain'] == "Pergantian Produk") : ?>
                    ...
                    <?php elseif ($komplain_barang[0]['jenis_komplain'] == "Pengembalian Dana") : ?>
                        <h4 class="mb-invoice-2">Form Konfirmasi Pengembalian Dana</h4>
                        <form method="POST" action="<?php echo base_url('user/order/konfirmasi_pengembalian_barang'); ?>">
                            <div class="form-group">
                                <label>Nama</label>
                                <input type="text" class="form-control" name="nama" readonly="" value="<?php echo $order[0]['nama_order']; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <select name="jenis_bank" id="" class="form-control">
                                    <option value="" disabled selected hidden>pilih jenis pengembalian</option>
                                    <?php foreach ($bank as $bnk) : ?>
                                        <option value="<?php echo $bnk['jenis_bank'] ?>"><?php echo $bnk['jenis_bank'] ?></option>
                                    <?php endforeach; ?>
                                </select>
                                <!-- <input type="text" class="form-control" name="jenis_bank" required=""> -->
                            </div>
