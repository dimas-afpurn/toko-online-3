                    ...
                    <div class="mt-2">
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <label class="ml-2">Nama Lengkap</label><?= form_error('nama_lengkap', '<small class="text-danger pl-3">', '</small>') ?>
                                <input name="nama_lengkap" required type="text" class="form-control" placeholder="nama lengkap" oninvalid="this.setCustomValidity('Nama Lengkap belum diisi')" oninput="setCustomValidity('')">
                            </div>
                        </div>

                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <label class="ml-2">No Hp</label><?= form_error('no_hp', '<small class="text-danger pl-3">', '</small>') ?>
                                <input name="no_hp" required type="number" min=0 class="form-control" placeholder="no hp" oninvalid="this.setCustomValidity('Nomor HP belum diisi')" oninput="setCustomValidity('')">
                            </div>
                        </div>

                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <label class="ml-2">Email</label><?= form_error('email', '<small class="text-danger pl-3">', '</small>') ?>
